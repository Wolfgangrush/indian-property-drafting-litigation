...
This plugin is one in the **Wolfgang Rush** family of Indian legal-drafting plugins:

| Plugin | GitHub repo | Scope |
|---|---|---|
| `supreme-court-drafting` | [supreme-court-drafting-litigation](https://github.com/Wolfgangrush/supreme-court-drafting-litigation) | SLPs · Transfer Petitions · Writs · Constitution Bench matters before the SC |
| `indian-hc-drafting` | [indian-hc-drafting-litigation](https://github.com/Wolfgangrush/indian-hc-drafting-litigation) | Pleadings before the 25 Indian High Courts (bench-config-aware) |
...
| `indian-contracts-drafting` | [indian-contracts-drafting-litigation](https://github.com/Wolfgangrush/indian-contracts-drafting-litigation) | Commercial contracts (MSA · NDA · Employment · Lease · Sale · GPA · SHA · Will · Loan · Arbitration) |
| `indian-banking-drafting` | [indian-banking-drafting-litigation](https://github.com/Wolfgangrush/indian-banking-drafting-litigation) | Banking / debt-recovery / SARFAESI / NI Act / IBC / civil-recovery pleadings |
| `indian-labour-drafting` | [indian-labour-drafting-litigation](https://github.com/Wolfgangrush/indian-labour-drafting-litigation) | Labour / industrial-disputes / employment / social-security / POSH pleadings |
| `indian-property-drafting` (this) | [indian-property-drafting-litigation](https://github.com/Wolfgangrush/indian-property-drafting-litigation) | Property / conveyancing / estate instruments — Gift · Exchange · Release · Trust · Wakf · Easement · Partition · Settlement · Mortgage · Title Investigation |

The family-of-plugins doctrine — each plugin narrowly scoped to one practice area — means each plugin can be installed independently, each plugin's Rule 36 firewall is narrow and reviewable, each plugin's State / forum discipline is depth-validated within its scope, and the user installs only what they need.

**Scope demarcation:** `indian-contracts-drafting` handles commercial-contract drafting (Sale Deed · GPA · Lease · Will · MSA · NDA · Employment · SHA · Loan · Arbitration). `indian-property-drafting` handles conveyancing-and-estate-instrument drafting that those contracts do not cover (Gift · Exchange · Release · Trust · Wakf · Easement · Partition · Settlement · Mortgage Deed · Title Investigation).
