...
**Plugin:** `indian-property-drafting` · **Forum:** Transactional / conveyancing — no forum (Stamp Act schedule and Registration State parametrised via state-config) · **Publisher:** Wolfgang Rush · **License:** MIT
